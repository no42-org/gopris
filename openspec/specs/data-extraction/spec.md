...
Extract data from heterogeneous sources into a single canonical record shape that the transform layer can consume uniformly, whether the source is a built-in extractor or an external subprocess.
