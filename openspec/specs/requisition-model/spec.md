# requisition-model Specification

## Purpose

Provide a typed, in-memory model of an OpenNMS requisition and serialize it to XML that conforms to the OpenNMS requisition import schema so that Provisiond accepts the import.
